...
function upsell_v2_product_upsell_display() {
    ...
    wp_enqueue_script('pu-modal');
    wp_enqueue_script('pu-general');
    wp_enqueue_script('pu-atc');
    wp_enqueue_style('pu-css-front');
...
?>
        ...
        <!-- upsell title -->
        <h5 id="upsell-v2-product-upsell-title" data-tracking-nonce="<?php echo wp_create_nonce('update single product upsell tracking data') ?>">
            <?php _e('Frequently Bought Together', 'woocommerce'); ?>
        </h5>
