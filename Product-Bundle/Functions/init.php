    ...
    if (class_exists('WooCommerce')) :
        ...
        function uv2_bundle_scripts() {
            ...
            if (is_product()) :
                ...
                // css front
                wp_enqueue_style('pb-css-front', UPSELL_V2_URI . 'Product-Bundle/Assets/CSS/front.css?' . $random_no);

                // general js
                wp_enqueue_script('pb-general', UPSELL_V2_URI . 'Product-Bundle/Assets/JS/general.js', ['jquery']);

                // modal js
                wp_enqueue_script('pb-modal', UPSELL_V2_URI . 'Product-Bundle/Assets/JS/modal.js', ['jquery']);

                // add to cart js
                wp_enqueue_script('pb-atc', UPSELL_V2_URI . 'Product-Bundle/Assets/JS/atc.js', ['jquery']);
